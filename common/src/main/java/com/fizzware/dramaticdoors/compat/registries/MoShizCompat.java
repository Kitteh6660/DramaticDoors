...
public class MoShizCompat
{
	...
	private static void registerRecipes() {
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_IRON_BAR, new ResourceLocation("ms", "door/iron_bar"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_GLOWOOD, new ResourceLocation("ms", "door/glowood"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_HELLWOOD, new ResourceLocation("ms", "door/hellwood"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_MAPLE, new ResourceLocation("ms", "door/maple"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_SILVERBELL, new ResourceLocation("ms", "door/silverbell"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_TIGERWOOD, new ResourceLocation("ms", "door/tigerwood"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_WILLOW, new ResourceLocation("ms", "door/willow"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_GLASS, new ResourceLocation("ms", "door/glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_SOUL_GLASS, new ResourceLocation("ms", "door/soul_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_TINTED_GLASS, new ResourceLocation("ms", "door/tinted_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_BLACK_GLASS, new ResourceLocation("ms", "door/black_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_GREY_GLASS, new ResourceLocation("ms", "door/grey_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_LIGHT_GREY_GLASS, new ResourceLocation("ms", "door/light_grey_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_WHITE_GLASS, new ResourceLocation("ms", "door/white_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_RED_GLASS, new ResourceLocation("ms", "door/red_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_ORANGE_GLASS, new ResourceLocation("ms", "door/orange_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_YELLOW_GLASS, new ResourceLocation("ms", "door/yellow_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_LIME_GLASS, new ResourceLocation("ms", "door/lime_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_GREEN_GLASS, new ResourceLocation("ms", "door/green_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_CYAN_GLASS, new ResourceLocation("ms", "door/cyan_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_BLUE_GLASS, new ResourceLocation("ms", "door/blue_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_PURPLE_GLASS, new ResourceLocation("ms", "door/purple_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_MAGENTA_GLASS, new ResourceLocation("ms", "door/magenta_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_PINK_GLASS, new ResourceLocation("ms", "door/pink_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_LIGHT_BLUE_GLASS, new ResourceLocation("ms", "door/light_blue_glass"), false);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MS_BROWN_GLASS, new ResourceLocation("ms", "door/brown_glass"), false);
