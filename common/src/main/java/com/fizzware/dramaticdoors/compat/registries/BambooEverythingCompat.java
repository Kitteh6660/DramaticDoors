...
public class BambooEverythingCompat
{
	...
	private static void registerRecipes() {
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_BE_BAMBOO, ResourceLocation.fromNamespaceAndPath("bambooeverything", "bamboo_door"), true);
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_BE_DRY_BAMBOO, ResourceLocation.fromNamespaceAndPath("bambooeverything", "dry_bamboo_door"), true);
